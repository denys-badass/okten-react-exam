...
export const MovieInfo: FC<MovieInfoProps> = ({movie}) => {
    ...
    const backdropUrl = backdrop_path ? import.meta.env.VITE_IMAGE_BASE_URL + '/original' + backdrop_path : '../../../public/movie_placeholder_lg.jpg';
        ...
        >
            ...
            <div className='z-10 px-8 w-7/8 mx-auto flex flex-col gap-4'>
                ...
                <div className='flex items-center w-full justify-between'>
                    ...
                    <div className='flex gap-2 items-center cursor-pointer' onClick={handleClickPoster}>
                        <p>Show poster</p>
                        <FaDisplay/>
                    </div>
                </div>
